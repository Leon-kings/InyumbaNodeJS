...
userActivitySchema.methods.isAnonymous =
  function () {
    return !this.userId;
  };
...
// Get activities by user
userActivitySchema.statics.getByUser =
  async function (
    userId,
    page = 1,
    limit = 20
...
// Get activities by action
userActivitySchema.statics.getByAction =
  async function (
    action,
    page = 1,
    limit = 20
...
// Get recent activities
userActivitySchema.statics.getRecent =
  async function (
    limit = 50
  ) {
    return await this.find()
...
// Get activity statistics
userActivitySchema.statics.getStatistics =
  async function () {
    const total =
...
// userActivitySchema.pre("save", function (next) {})
//
// The middleware is intentionally synchronous here.
// This prevents:
//
